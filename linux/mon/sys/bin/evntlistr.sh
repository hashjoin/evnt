#!/bin/ksh
#
# $Header evntlistr.sh 03-SEP-2008 1.8
#
# File:
#	evntlistr.sh
#
...
#
# Usage:
#	evntlistr.sh <list_File> <error_file>
#
# Desc:
#	Builds list of pending EVENTS (remote) to process
#
# History:
...
#	03-SEP-2008	VMOGILEV	1.8 LOCAL_HOSNAME is now set in MON.env
#
